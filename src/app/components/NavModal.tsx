...
const NavModal: React.FC<NavModalProps> = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <nav
      className={`fixed top-0 right-0 h-[100vh] bg-[#421205]/80 backdrop-blur-md pl-20 pr-4 pt-12 flex flex-col justify-start items-end gap-y-5 transition-transform duration-300 border-l-4 border-black/50 ${
